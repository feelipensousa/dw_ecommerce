  ...
  create  table "dwecommerce01"."public_public_gold"."gold_kpi_tb_sales__dbt_tmp"
...
WITH sales_KPI AS (
    SELECT *
    FROM "dwecommerce01"."public"."silver_sales"
),
clients AS (
    SELECT
        client_id,
        ...
        age
    FROM "dwecommerce01"."public"."silver_clients"
),
products AS (
    SELECT
        product_id,
        category
    FROM "dwecommerce01"."public"."silver_products"
),
dates AS (
    SELECT
        order_id,
